...
The token moves across the board based on the random number displayed by the dice once rolled and carries on until one of the player is on finial square.
